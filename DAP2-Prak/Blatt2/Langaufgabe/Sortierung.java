public class Sortierung{
    ...
    public static void main(String[] args){
        ...
        if(args.length == 1){ // Arbeiten mit MergeSort
            System.out.println("Sortiere mit MergeSort");
        ...
        if(args.length == 3){
            ...
            if(args[1].equals("insert") ){
                ...
                System.out.println("Fehlerhafter Algorithmus");
                syntaxteller();
                return;
            }
    ...
    // Fehler in den Folien mit ">" anstatt von ">0", bei ">" 'vergisst' insertionSort bei aufsteigender
    ...
    /* Ineffizienter Algorithmus, ohne Array-Größen-Optimerung
    private static void merge(int[] intArr, int p, int q, int r){
