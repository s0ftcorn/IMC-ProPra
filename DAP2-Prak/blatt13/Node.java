 ...
 * Hat natürliche Ordnung bzgl. ID
...
public class Node implements Comparable<Node>
{
    ...
    /**
     * Fügt eine neue Kante in die Adjazenzliste des Knotens ein
    ...
    public boolean addEdge(Node v, double c){
        ...
        if (adj.contains(e)) return false;
        return adj.add(e);
    }
    
    /**
     * Ändert eine Kante in der Adjazenzliste des Knotens
     * @param v Endknoten der Kante
     * @param c neue Kosten der Kante
     * @return true, wenn die Kante bereits exisitiert und ge�ndert wurde
     */
    public boolean changeEdge(Node v, double c){
        Edge e = new Edge(this,v,c);
        if (!adj.remove(e)) return false;
        return adj.add(e);
    }
    
    /**
     * LÖscht eine Kante aus der Adjazenzliste
     * @param ezu lÖschende Kante
    ...
    public boolean deleteEdge(Edge e){
     ...
     /**
     * Löscht eine Kante aus der Adjazenzliste
     * @param v Endknoten der zu löschenden Kante
     * @return true, wenn die Kante vorhanden war
     */
    ...
    /**
     * Gibt eine Kopie der Adjazenzliste zurück
     ...
     * @return eine Zahl kleiner/gleich/größer 0, wenn die ID
     * dieses Knotens kleiner/gleich/größer der des anderen Knotens ist
     */
     ...
     * @return eine Zahl kleiner/gleich/größer 0, wenn die ID
     * dieses Knotens kleiner/gleich/größer der anderen ID ist
     */
