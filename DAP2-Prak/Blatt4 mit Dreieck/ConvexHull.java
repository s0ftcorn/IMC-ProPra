        ...
        */
        ...
        while (!endIt) {
            ...
            if (temp.size() == 2) {
                ...
                double smallestLength = Math.sqrt(((temp.get(0).getX()-temp.get(0).getY())*(temp.get(0).getX()-temp.get(0).getY()))+(temp.get(1).getX()-temp.get(1).getY()*(temp.get(1).getX()-temp.get(1).getY())));
                findFrom = temp.get(1);
                for (int i = 2; i<temp.size(); i += 2) {
                    double nextLength = Math.sqrt(((temp.get(i).getX()-temp.get(i).getY())*(temp.get(i).getX()-temp.get(i).getY()))+(temp.get(i+1).getX()-temp.get(i+1).getY()*(temp.get(i+1).getX()-temp.get(i+1).getY())));
